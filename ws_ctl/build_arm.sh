...
mkdir -p build/${ARCH}/${BUILD_TYPE}/ws_ctl
...
rsync -avc --progress ${PROJECT_ROOT}/release/${ARCH}/${BUILD_TYPE}/ws_ctl/bin/ws_ctl dima@192.168.1.41: || exit -1
rsync -avc --progress ${PROJECT_ROOT}/web/* --exclude=CMakeLists.txt dima@192.168.1.41:web || exit -1