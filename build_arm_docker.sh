...
CXXFLAGS="-L/usr/lib/aarch64-linux-gnu -lOpenCL -mabi=lp64 -march=armv8.2-a+crypto+fp16+rcpc+dotprod -mcmodel=small -mcpu=cortex-a76.cortex-a55+crypto -mtune=cortex-a76.cortex-a55 -DCV_OPENCL_RUN_VERBOSE ${CMAKE_CXX_FLAGS}"
#
